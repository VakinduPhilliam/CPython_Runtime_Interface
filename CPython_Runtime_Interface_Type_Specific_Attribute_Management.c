...
/*
 ...
 This example effectively does the same thing as the generic attribute, but does not use the generic support added in Python 2.2.
...
PyErr_Format(PyExc_AttributeError, "'%.50s' object has no attribute '%.400s'", tp->tp_name, name);
